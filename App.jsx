      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "0 2rem", paddingTop: "56px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", width: "100%", paddingTop: "6rem", paddingBottom: "6rem" }}>
          ...
          <p style={{
            ...
            10+ years designing scalable cloud and enterprise systems — from AWS data platforms to industrial automation. Previously at USAA and CenturyLink.
          </p>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <FadeIn>
            ...
            <h2 style={{ fontSize: "36px", fontWeight: "300", letterSpacing: "-0.02em", marginBottom: "3rem", color: "#0f0f0d" }}>
              Full stack,<br /><em style={{ fontStyle: "italic", color: "#999" }}>cloud to client</em>
            </h2>
          </FadeIn>
            ...
            {PROJECTS.map((p, i) => (
              <FadeIn key={p.title} delay={i * 0.1}>
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: "8px", paddingTop: "4px", borderTop: "1px solid #f0efe8" }}>
                    <a href="#" style={{ fontSize: "12px", color: p.color, textDecoration: "none", fontWeight: "500" }}>GitHub →</a>
                    <a href="#" style={{ fontSize: "12px", color: "#999", textDecoration: "none" }}>Live demo</a>
                  </div>
                </div>
              </FadeIn>
            ))}
          ...
          <FadeIn delay={0.2}>
            <div style={{ borderTop: "1px solid #222", paddingTop: "2rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
              <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "12px", color: "#444" }}>
                © 2026 Jacob S. Harlow · Built with React · Deployed on AWS
              </span>
              <div style={{ display: "flex", gap: "1.5rem" }}>
                <a href="#" style={{ fontSize: "12px", color: "#555", textDecoration: "none" }}>GitHub</a>
                <a href="#" style={{ fontSize: "12px", color: "#555", textDecoration: "none" }}>LinkedIn</a>
              </div>
            </div>
          </FadeIn>
        </div>
